export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9a37c98f4e5d250f",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1b71292ceb4e25a3fc69261104f9c614",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "AoeTgWWDGfeV3V1TVLceYN6fBGoi70YHj4g3aN_wc2c",
      // 所在省份
      province: "福建",
      // 所在城市
      city: "莆田",
    ...
    // ...
     // 想要发送的人的名字
      name: "爹爹来报",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oZnQ569coTyH21zhURKxuuSmshaI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "AoeTgWWDGfeV3V1TVLceYN6fBGoi70YHj4g3aN_wc2c",
      // 所在省份
      province: "福建",
  ...
  CALLBACK_TEMPLATE_ID: "AoeTgWWDGfeV3V1TVLceYN6fBGoi70YHj4g3aN_wc2c",
